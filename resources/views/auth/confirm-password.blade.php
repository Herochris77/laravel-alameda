    ...
    <div class="auth-wrapper">
        <div class="auth-card">
            <div class="auth-header">
                ...
                <p class="auth-subtitle">Área segura del sistema</p>
            </div>
            ...
            <div class="auth-body">
                ...
                <div class="info-box">
                    ...
                    <span>Esta es un área segura del sistema. Por favor confirma tu contraseña antes de continuar.</span>
                </div>
            ...
            <div class="auth-footer">
                <p><a href="{{ route('dashboard') }}"><i class="arrow left icon"></i> Volver al inicio</a></p>
            </div>
        </div>
    </div>
</body>
...
<script>
    ...
    document.getElementById('confirmForm').addEventListener('submit', function() {
        ...
        if (btn) {
            btn.disabled = true;
            btn.innerHTML = '<i class="spinner loading icon"></i> Confirmando...';
        }
    });
</script>
